...
We accept returns for unopened and unused items within 2 hours of delivery. Contact us at onebloominnovation01@gmail.com with your order number for assistance.
              </p>
            </div>
          )}
        </div>
          ...
          {activeTab === 5 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                ...
                you've ordered, you can return them for a refund within 2 hours
                of delivery.
              </p>
            </div>
          )}
